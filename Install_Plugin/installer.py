...
def get_plugin_version():
    try:
        manifest_path = os.path.join(plugin_path, "3e6d64e0_pro", "manifest.json")
...
plugin_folder_withVersion = "3e6d64e0_pro" + "_" + plugin_version
plugin_folder = os.path.join(plugin_path, "3e6d64e0_pro")
    ...
    def install_plugin(self):
        try:
            ...
            for folder_name in os.listdir(adobe_plugins_storage):
                if folder_name.startswith("3e6d64e0_pro"):
            ...
            if os.path.exists(ps_json_path):
                ...
                data["plugins"] = [
                    ...
                    if plugin["pluginId"] != "3e6d64e0_pro"
                ]
