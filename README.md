<details>
<summary><b>📜本仓库是在V1.93的基础上优化和升级而来，它具有以下特点(点击展开/Click to expand)：</b></summary>
   <ul>
 ...
 <li> 8. 2026.4.4日版本已添加局域网多用户端支持，局域网中多台电脑PS插件可以连接同一台comfyui服务器进行生图，使用独自的工作流，采用队列方式。</li>
</ul>
